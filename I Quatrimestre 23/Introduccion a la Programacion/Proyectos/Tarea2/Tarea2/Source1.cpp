...
int main() {
	float ventas, sueldo = 250000, incentivo = 0;
	cout << "Digite el monto de lo vendio por el empleado: \n";
	cin >> ventas;

	//condiciones
	if (ventas >= 200000) {
		incentivo = (ventas * 0.08) + sueldo;

	}
	else if (ventas >= 150000 && ventas < 200000) {
		incentivo = (ventas * 0.06) + sueldo;
	}
	else if (ventas >= 90000 && ventas < 150000) {
		incentivo = (ventas * 0.04) + sueldo;
	}
	else {
		incentivo = (ventas * 0.01) + sueldo;		
	}
